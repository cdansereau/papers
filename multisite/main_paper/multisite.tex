...
\caption[inter vs. intra site variability]{
 Distribution of intra-site (between-subject) standard deviation vs. inter-site (between-site) standard deviation, based on the standard deviation of the connectivity matrices from a subset of 8 sites from the 1000 functional connectome dataset. A) The average intra-site vs. inter-site bias distribution. B) Detailled intra-site standard deviation for each site. C) Detailled inter-site absolute bias for each site.
}
