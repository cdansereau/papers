...
\title{Statistical power and site effects in multisite resting-state fMRI connectivity}
...
\end{center}
\caption[]{
Standard deviation of resting-state connectivity across subjects, average across all connections, at each site.
}
...
\end{center}
\caption[]{
Average connectomes for individual sites, as well as connections with a significant site effects. This Figure is identical to Figure 2 in the paper, with the difference that the cambridge site was excluded from the analysis.
}
