...
A) Reference map of the default mode network (DMN). With labels for principal structures of the DMN.
D)Regions identified to display significant inter-site differences across all sites and for the whole connectome. The map is threshold to 0.1
