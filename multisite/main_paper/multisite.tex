...
148 subjects randomly selected were used from that sample 120 were used for training the model and the remaining 28 subjects were kept for testing.
...
\begin{itemize}
 ...
 \item The same prediction analysis was perform althought only training on 80 subjects and testing on the rest of the 148 subejects.
\end{itemize}
...
\end{center}
\caption[inter vs. intra site variability]{
Distribution of intra-site (between-subject) standard deviation vs. inter-site (between-site) standard deviation, from a subset of 8 sites from the 1000 functional connectome dataset for the selected 10 seeds. A) Intra-site standard deviation for each site. B) Inter-site effect size expressed in Cohen's $d$ for eahc site.
}
...
One of the main and most interesting finding for the prediction simulation is the fact that multivariate analysis seams to  require no linear correction for site-effect before training.
