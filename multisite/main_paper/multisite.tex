...
\textit{Conclusion:} These results support the feasibility of multisite dataset and in particular of pooled datasets from heterogeneous nature \emph{I think it's great to have a ``big picture'' summary at the end of the abstract. But this is too vague. ``the feasibility of multisite dataset'' for example means that you are able to collect data at multiple sites. This is not what you actually mean here. Please rephrase, keep it general but make it accurate}.
\end{abstract}
