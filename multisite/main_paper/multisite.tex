...
\centering
\captionsetup[subfloat]{labelformat=empty}
\subfloat[][Debalancing 50\%]{\includegraphics[width=0.32\textwidth]{../figures/realdata_detect_pow_s120_50pct.png}}
\hspace{1mm}
\subfloat[][Debalancing 30\%]{\includegraphics[width=0.32\textwidth]{../figures/realdata_detect_pow_s120_30pct.png}}
\hspace{1mm}
\subfloat[][Debalancing 15\%]{\includegraphics[width=0.32\textwidth]{../figures/realdata_detect_pow_s120_15pct.png}}
\hspace{1mm}
\caption{
