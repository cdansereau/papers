...
\paragraph{Source of variance across sites} 
...
\begin{itemize}
 \item Propose a method to account for multisite variance in a general linear model analysis. %Evaluate our ability to correct for inter-site variance using a statistical model.
 \item Amount of variance intra-site and inter-site. %Characterize the amplitude of inter-site bias.
 ...
 \item Interaction of site-pathology and it's impact on detection power.
 \end{itemize}
\end{itemize}


\paragraph{Other info} 
Cite for the urgency of using pool mutisite data for neuro-imaging analysis \cite{Cheng2015}.
